    ...
    if (!Array.isArray(value)) {
      ...
      switch (value[0]) {
        ...
        case `EXISTS`:
          ...
          break;
        default:
          //   console.error('UNEXPECTED QUERY VALUE');
          queryItem = `UNEXPECTED QUERY VALUE`;
          break;
      }
    }
...
export class WebSocketClient extends EventEmitter {
  ...
  private thisReconnectCount: number;
  ...
  constructor(
    ...
    super();
    this.thisReconnectCount = this.reconnectCount;
  ...
  private onClose() {
    ...
    if (
      ...
      (this.thisReconnectCount > 0 || this.thisReconnectCount === -1)
    ) {
      if (this.thisReconnectCount !== -1) {
        this.thisReconnectCount -= 1;
      }
